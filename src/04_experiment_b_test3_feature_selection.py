...
OUTPUT_RESULTS = DATA_DIR / "experiment_b_test3_results.csv"
...
def main():
    ...
    summary = pd.DataFrame([{
        "experiment": "B_Test3_Feature_Selection",
        "features": "Top 20 Stat + Semantic",
    ...
    print("\nEXPERIMENTO B - TESTE 3: SELEÇÃO DE FEATURES ESTATÍSTICAS")
    print("Features estatísticas selecionadas: 20")
