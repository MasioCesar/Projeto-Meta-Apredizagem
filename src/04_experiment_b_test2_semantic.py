...
OUTPUT_RESULTS = DATA_DIR / "experiment_b_test2_results.csv"
...
def main():
    ...
    ignore_cols = [
        "did", "name", "predicted_domain", "domain", "domain_score",
    ...
    numeric_cols = [col for col in X_b.columns if col != "semantic_text"]
    ...
    summary = pd.DataFrame([{
        "experiment": "B_Test2_Semantic",
        "features": "Stat + Better Semantic (300 feats, bi-grams)",
    ...
    print("\nEXPERIMENTO B - TESTE 2: FEATURES SEMÂNTICAS MELHORADAS")
    print("Features semânticas máximas TF-IDF: 300 (uni e bi-gramas)")
