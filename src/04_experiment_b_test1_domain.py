...
OUTPUT_RESULTS = DATA_DIR / "experiment_b_test1_results.csv"
...
def main():
    ...
    # Removendo apenas o que vaza ou é inútil. Mantemos predicted_domain e domain_score!
    ignore_cols = [
        "did",
        "name",
        "domain", # Removendo o real que pode faltar
        "best_classifier",
        "best_accuracy"
    ] + all_possible_classifier_cols
    ...
    summary = pd.DataFrame([{
        "experiment": "B_Test1_Domain",
        "features": "Stat + Semantic + Domain",
    ...
    print("\nEXPERIMENTO B - TESTE 1: DOMÍNIO (ONE-HOT ENCODING)")
